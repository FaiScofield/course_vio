...
dt = dlmread('../data/data_vio_imu_sim_gyr_t.txt');         
data_x = dlmread('../data/data_vio_imu_sim_gyr_x.txt'); 
data_y= dlmread('../data/data_vio_imu_sim_gyr_y.txt'); 
data_z = dlmread('../data/data_vio_imu_sim_gyr_z.txt'); 
data_draw=(data_x+data_y+data_z)/3 /3600;

data_sim_x= dlmread('../data/data_vio_imu_sim_sim_gyr_x.txt'); 
data_sim_y= dlmread('../data/data_vio_imu_sim_sim_gyr_y.txt'); 
data_sim_z= dlmread('../data/data_vio_imu_sim_sim_gyr_z.txt'); 
