...
int main(int argc, char *argv[])
{
    ...
    cout << endl << "Generate a rotation matrix:" << endl << R << endl ;
    ...
    delta_q.normalize();
    cout << endl << "Small change w to quaternion(1, w/2) to rotation matrix:"
         << endl << delta_q.toRotationMatrix() << endl;

    // R*exp(w^)更新结果
    Sophus::SO3<double> SO3_R1 = SO3_R * Sophus::SO3<double>::exp(w);
    cout << endl << "Update Rotation matrix with R*exp(w^):" << endl << SO3_R1.matrix() << endl;
    ...
    cout << endl << "Update Rotation matrix with q*[1, w/2]:" << endl << R2 << endl;
